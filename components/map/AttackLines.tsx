...
export default function AttackLines({
  ...
  > = {
    ...
    "israel-iran": [
      ...
      { from: [34.5, 47.5], to: [36.19, 44.0], size: 10, rotation: 215, duration: "1.5s", color: "#1FBD00", width: 3, length: 1500, delay: 600 },
      { from: [32.0, 48.0], to: [33.51, 36.27], size: 10, rotation: 190, duration: "5s", color: "#1FBD00", width: 3, length: 1300, delay: 900 },
      { from: [30.0, 50.0], to: [29.55, 34.95], size: 10, rotation: 185, duration: "3s", color: "#1FBD00",width: 3, length: 900, delay: 2000 },
      { from: [32.08, 34.78], to: [35.55, 50.8], size: 10, rotation: 345, duration: "3s", color: "#0038B8", width: 3, length: 1100, delay: 1500 },
