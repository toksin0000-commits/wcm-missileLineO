...
export default function MiniMap({ area }: MiniMapProps) {
  return (
    <div className="w-full h-48 border border-cyan-900/30 relative overflow-hidden group">
      ...
      {/* Digitální šum */}
      <div className="absolute inset-0 pointer-events-none bg-cyan-500/5 opacity-20 bg-[linear-gradient(rgba(18,16,16,0)_50%,rgba(0,0,0,0.25)_50%),linear-gradient(90deg,rgba(255,0,0,0.06),rgba(0,255,0,0.02),rgba(0,0,255,0.06))] bg-size-[100%_2px,3px_100%]"></div>
    </div>
  );
}
